...
.raven-app .dashboard-screen .dashboard-data-grid { margin: 14px 20px 0; gap: 10px; border-bottom: 0; }
.raven-app .dashboard-screen .dashboard-data-item,
.raven-app .dashboard-screen .dashboard-data-item:nth-child(odd),
.raven-app .dashboard-screen .dashboard-data-item:nth-child(even),
.raven-app .dashboard-screen .dashboard-data-item:nth-child(-n+2) { min-height: 84px; padding: 12px; border: 1px solid var(--line); border-radius: 8px; background: #0f120f; }
